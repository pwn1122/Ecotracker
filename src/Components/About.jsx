...
//     <div>
//         <Navbar/>
//       <section id="about" className="about max-w-4xl mx-auto p-6 text-left">
...
//       <section>
//       <div className="flex items-center justify-center min-h-screen bg-cover bg-center" style={{ backgroundImage: "url('/img/forest.webp')" }}>
