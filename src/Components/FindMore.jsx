...
//                         <div className="mt-2">
//                            <a href="https://x.com/ritviksoni11?t=v1N4XU45yskArH3_BEEubg&s=09"><i className="fab fa-twitter mx-2"></i></a> 
//                             <a href="https://www.facebook.com/share/HmckeH2swdeA1h2N/"><i className="fab fa-facebook mx-2"></i></a>
//                             <a href="https://www.linkedin.com/in/ritvik-soni-80694b29a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><i className="fab fa-linkedin mx-2"></i></a>
//                         </div>
//                     </header>
//                     <main className="p-4">
...
//                         <section className="bg-white rounded shadow-md p-4 my-4">
//                             <div className="flex flex-col md:flex-row">
//                                 <div className="md:w-1/4 font-bold text-xl mb-2 md:mb-0">
